...
if(ros_distro==1):
    ...
    #Run the script
    subprocess.call("(./week3/build/camera-interface/mainsub 1 /usb_cam/image_raw)",shell=True) 
...
#For ROS2
    ...
    #Run the script
    subprocess.call("(./week3/build/camera-interface/mainsub 2 /camserver/rgb)",shell=True) 
